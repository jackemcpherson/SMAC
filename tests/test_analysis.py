...
from smac.analysis import SMACConfig, SMACResult, run_smac_analysis, analyze_ticker
...
class TestSMACResult:
    ...
    def create_sample_result(self) -> SMACResult:
        ...
        data = pd.DataFrame({
            ...
            'short_sma': [100, 100.5, 101, 100.5, 100, 100.5, 101.5, 102.5, 103, 104],
            'long_sma': [100, 100.2, 100.5, 100.3, 100.1, 100.3, 100.8, 101.2, 101.8, 102.5],
...
class TestAnalysisFunctions:
    ...
    def test_run_smac_analysis(self, mock_signals: Mock, mock_sma: Mock, mock_fetch: Mock) -> None:
